...
Bearer summons a swarm of tiny bug‑like creatures that persist for one minute. The swarm's level is equal to the artifact's level. The swarm attacks a designated foe within short range and hinders their perception tasks for the duration. 
