...
tags:
  ...
  - Artifact
title: Deck of Second Chances
collection: Artifacts
kind: Artifact
id: deck-of-second-chances
categories:
- Weird-West
---
## Deck of Second Chances
...
Each time the bearer of the deck (or a member of a group linked to the deck) would otherwise die, a random card is drawn and disappears from the deck. The beneficiary of this effect immediately regains Pool points equal to the artifact's level they can allocate however they choose. 
