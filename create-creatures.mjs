...
const allCreatures = [
  {
    ...
    combat: "Alchemists use long range pistols or rifles. At least one of their bullets may be alchemical. A forgeborn assistant also accompanies most alchemists, often helping with defense. A given alchemist also has one or two alchemical resources available: Empower (regain 11 health, +3 Armor for one minute), Petrify (turn targets to stone), Flummox (targets attack allies), Blast (acidic explosion), or Non-Combat Alchemy (revive dead, animate flesh, transmute materials).",
  ...
  },
  {
    ...
    combat: "A dire coyote bites each round. Additional traits: Forlorn Howl (4 points Intellect damage in short area, causes terror), Ghost eater (affects incorporeal spirits, heals to full when destroying ghosts), or Ignite Gun (guns ignite when damaging the coyote).",
  ...
  },
  {
    ...
    description: "A frostwalker is a cursed beast made of packed snow layered over the severed limbs, heads, gristle, antlers, and sinew from deer, wolves, and sometimes people who've died in the cold. As such, they vary in appearance. Some are about the size of wolves, others are human‑sized with antlers, and a few can be up to twice the size of a person.",
    combat: "Frostwalkers bite, gore, or claw with whatever body part they have available. Additional abilities: Frozen (regain health from cold damage), Scream the Blizzard (4 points cold damage, freezes targets), Small and Quick (long movement, 1 Armor), or Snow Monster (larger size, 24 health, attacks twice).",
  ...
  },
  {
    ...
    modifications: "",
    description: "Intermittently ridden straight out of Hell by demons wearing borrowed flesh, the Damned, and others seeking to escape the accursed underworld, hellfire steeds are demonic, fire‑dripping destriers. Their manes are boiling napalm, their glowing red hooves leave prints that burn and smolder for days, and a single demonic horn curls from their brows.",
    combat: "Hellfire steeds attack twice each round with their horn. Additional traits: Fires of the Underworld (2 points fire damage to nearby creatures), Lifedraining Horn (additional 5 Speed damage, heals steed), Render Immune to Fire (rider gains fire immunity), or From Hell (portal travel once per year). Death Gallop: final charge when killed deals 5 fire damage along route.",
  ...
  },
  {
    ...
    description: "Dwelling in steaming, acidic hot springs, sulfur stalkers' umbral, scaled bodies can reach lengths of 10 or more feet (3 m). Their broad, flat heads feature wide, gaping mouths filled with rows of sharp teeth. Feathery tendrils fringe their heads, twining and stretching as if of their own accord.",
    combat: "Sulfur stalkers bite. Additional abilities: Tendril Aura (3 acid damage to nearby creatures), Acid Geyser (9 damage in line, usable every few minutes), or Regrow (2 health per round unless damaged by cold/magic).",
    interaction: "Sulfur stalkers have a language, and some can speak human tongues, especially those that have made deals with locals. Such deals usually involve turning over some number of other people each year for the stalker to eat.",
    ...
    loot: "Cast‑off belongings can sometimes be found in their nests. In addition, a nest might contain an egg or two, each equal in value to an expensive item.",
    gmIntrusion: "A severed segment of a sulfur stalker animates as a half‑size, level 3 sulfur stalker that attacks the character."
  },
  {
    name: "Angalith",
    level: 5,
    ...
    combat: "Angaliths slice foes with jagged edges of their stained glass wings. Prismatic Blaze: Six prismatic shafts illuminating sins (Red-Wrath, Orange-Envy, Yellow-Apathy, Green-Greed, Blue-Gluttony, Indigo-Pride). Forgeborn Traits: Dim, Temperamental, Resistant, and Quiet.",
    interaction: "Angaliths resonate with the worship and faith their component parts once witnessed. Often, that faith was preaching about the welfare of other beings, so they may stop to help those in need.",
    use: "Angaliths—like most forgeborn—are tough encounters even for those who are tooled up for a fight. However, they can be assuaged with promises of saintly acts or demonstrations of good works.",
    gmIntrusion: "The character sliced by the jagged edge of a stained glass wing begins bleeding for 1 ambient damage each round until someone succeeds on a difficulty 3 healing task."
  },
  {
    name: "Inkubus",
    level: 4,
    ...
    combat: "Inkubuses slice targets with knife‑sharp paper cuts. Additional traits: Word of Power (Stunned, Confess, Betray, or Forget effects), Words on the Floor (send written messages), and Forgeborn Traits (Resistant and Temperamental).",
  ...
  },
  {
    ...
    description: "Hex gunners weave iron and lead with Hellish sorcery. Gifts from a demon gained during a crossroads deal, a hex gunner's six‑shooters are demonic constructs that grant the equivalent of years of practice and occult study. Their bullets whisper in the chamber, smoking with necromancy, then scream with exultant, hellish fury when fired.",
    combat: "A hex gunner makes two long‑range pistol attacks as their action. Hell‑Hexed Rounds: cursed bullets that remain in wounds until surgically removed. Grave Round: shoot corpses to raise zombies that serve for a day.",
    interaction: "Hex gunners are mainly concerned with reaping more souls for whoever they are pledged to. Usually, they prefer those souls be already tainted by evil, but hex gunners are angry and impatient as a rule.",
  ...
  },
  {
    ...
    modifications: "",
    description: "Alchemists who learn enough science and magic to retain corporeal existence after death, like risen, might transition to necrovore status. Unlike a risen, a deathbinder ensures their eternal existence by placing splinters of their soul into six bullets chambered in a \"soul pistol.\"",
    combat: "A deathbinder attacks twice each round with long‑range pistol attacks. Alchemical Pistol: special effects like freezing in amber, learning secrets, or teleportation. Soul Pistol: automatically hits, causes damage track descent, curses target. Alchemical Resurrection: reforms in 1d6 days unless all soul bullets are fired.",
  ...
  },
  {
    ...
    description: "Cloaked in a tattered duster and riding nothing but a memory, the necrovore known as a hollowed ranger is a traveling portal to elsewhere—perhaps connecting to a nightmare, the far future after everyone has died, or some region of Hell where corpses shamble beneath an eternal eclipse.",
    combat: "A hollowed ranger's long‑range entropic bullet deals 4 points of Intellect damage (ignores Armor). Necrovore Door: summons wraith lord for one minute. Fall Into Oblivion: sucks targets into deathly realm for soul drain. Door Shift: instant transport across miles.",
  ...
  },
  {
    ...
    modifications: "",
    description: "Clawed back into \"life\" thanks to a promise, an alchemical experiment, or a demonic curse straight out of Hell, risen look normal enough—from a distance. Up close, something ain't right. Risen—also known as the Damned—spook horses and set dogs to growling.",
    combat: "A risen makes a long‑range pistol attack. Additional traits: Damned Rounds (Hell-tainted bullets cause combustion), Necrovore Resilience (survive fatal wounds once per encounter), and Sometimes They Come Back (reanimate unless properly destroyed).",
    ...
    gmIntrusion: "The character recognizes the risen as someone they personally killed and is dazed with surprise until the end of their next turn."
  },
  {
    name: "Tombdrift",
    level: 5,
    ...
    description: "Necrovore sand dunes 30 feet (9 m) in diameter are sometimes seeded from those who die in the desert and are buried only by shifting sands. When inactive, it's nearly impossible to distinguish tombdrifts from regular desert dunes.",
    combat: "The tombdrift abrades every creature in immediate range with scouring sand. Additional attacks: Drain Life (3 Speed damage, sickens target), Dust Devil Speed (long-distance charge attack), and Sand Regeneration (1 health per round in desert).",
    interaction: "When they take the echo of their former shape, tombdrifts can communicate in rasping voices, and may choose to negotiate with other creatures instead of draining their life.",
    ...
    loot: "A tombdrift might have some belongings from the individual who seeded it, such as a box with a few remaining alchemical rounds.",
    gmIntrusion: "The character is pulled into the dune and is crushed and suffocated for 5 points of ambient damage each round until they can escape."
  },
  {
    ...
    description: "Though thankfully rare, shades of the tomb (commonly called \"tomb shades\") may spontaneously manifest beneath the dull light of the Tomb Moon, taking form from gravestone shadows. When they resolve, they regard the world with the head of an ink-beaked raven, with half a dozen clutching ebony arms emerging from their tenebrous cloak.",
    combat: "A tomb shade's touch drains life, inflicting Speed damage (ignores Armor). In dim light and darkness, only takes 1 damage from attacks. Additional abilities: Siphon (necrotic ray heals shade), Darken (magical darkness area), Anguish (drain joy from area), or Portal (necrotic implosion).",
  ...
  // CURSED BEASTS (from quick reference list)
  {
    name: "Chupacabra",
    level: 3,
    armor: 2,
    ...
    environment: "Almost anywhere, but prefers rural areas",
    modifications: "Speed defense as level 4 due to quickness; stealth and perception as level 7",
    description: "Part huge dog, part crocodile; quilled like a porcupine. Chupacabras are mysterious predators that drain the blood of livestock and sometimes people.",
    combat: "Chupacabras bite for 5 points of damage. Long‑range quill attack puts target to sleep for one hour on a failed difficulty 5 Might defense roll (target can try to wake each round)."
  },
  {
    name: "Quetzalsaur",
    level: 6,
    ...
    categories: ["Weird-West", "Cursed-Beast"],
    kind: "Creature",
    motive: "Territorial predator",
    environment: "Mountain peaks and high plateaus",
    modifications: "Speed defense as level 4 due to size",
    description: "Giraffe‑sized monstrosity with a 40‑foot (12 m) wingspan. These ancient predators combine the worst aspects of pterosaur and necromancer.",
    combat: "Flies a long distance each round. Beak attack for 7 points of damage. Vomits up two zombie helpers (corpses of past victims) once per conflict."
  },
  {
    name: "Grizzly Bull",
    level: 6,
    ...
    modifications: "Speed defense as level 5 due to size; breaking through walls as level 8",
    description: "Bison bull magically crossed with a grizzly bear. These massive hybrids combine the charging power of a bull with the ferocity of a grizzly.",
    combat: "Horns attack deal 6 points of damage. If a foe within immediate range misses the bull, the grizzly bull gets an immediate extra attack."
  },
  {
    name: "Deathtumbler",
    level: 3,
    ...
    categories: ["Weird-West", "Cursed-Beast"],
    kind: "Creature",
    motive: "Feed on carrion and living flesh",
    environment: "Desert and plains",
    modifications: "Speed defense as level 4; disguise (as rotting carrion) as level 6",
    description: "Human‑sized tumbleweeds whose \"thorns\" are actually animal fangs. These ambulatory plants roll across the landscape, feeding on whatever they can catch.",
    combat: "Slashes with toothed branches for 3 points of damage. Mundane attacks deal only 1 point of damage each. Attacks all targets in immediate area if it has surprise, dealing damage and 3 additional points of Speed damage (ignores Armor) on a failed Might defense roll."
  },
  {
    name: "Jackalope",
    level: 2,
    ...
    categories: ["Weird-West", "Cursed-Beast"],
    kind: "Creature",
    motive: "Mischief and territory defense",
    environment: "Plains and desert",
    modifications: "Speed defense as level 4; stealth and illusions as level 5",
    description: "Jackrabbit with the horns of an antelope. These trickster creatures use illusions to confuse and mislead travelers.",
    combat: "Gores with antlers for 3 points of damage. Creates illusion that can fill a short area and lasts for ten minutes or until interacted with."
  },
  {
    name: "Nightcrawler",
    level: 4,
    ...
    health: 12,
    damage: "5 points",
    movement: "Short; burrows",
    categories: ["Weird-West", "Cursed-Beast"],
    kind: "Creature",
    motive: "Feed on flesh",
    environment: "Underground tunnels and caves",
    modifications: "Speed defense as level 3",
    description: "20‑foot (6 m) long earthworm with skin stripped from past prey. These horrific predators tunnel through earth and emerge to drag victims underground.",
    combat: "Bite deals 5 points of damage. Can burrow to avoid attacks and emerge unexpectedly."
  },
  // FORGEBORN (from quick reference list)
  {
    name: "Locomotem",
    level: 6,
    armor: 5,
    ...
    environment: "Industrial areas and rail yards",
    modifications: "Speed defense as level 4 due to size",
    ...
    combat: "Attacks with massive fists for 7 points of damage. Steam whistle (once per hour) stuns creatures in immediate range on failed Might defense roll. Has standard forgeborn traits."
  },
  {
    name: "Fleshmare",
    level: 4,
    ...
    combat: "Hoof attack deals 6 points of damage. Electrical damage heals instead of harms fleshmare. Has standard forgeborn traits."
  },
  {
    name: "Alchehemoth",
    level: 5,
    ...
    combat: "Fists deal 7 points of damage. Inebriating breath causes creatures in immediate range to fall into booze‑fueled slumber for one hour on failed Might defense roll. Has standard forgeborn traits."
  },
  // GUNFIGHTERS (from quick reference list)
  {
    name: "Bounty Hunter",
    level: 4,
    armor: 1,
    ...
    combat: "Attacks twice with long‑range pistol. A melee attack with locking cuffs (level 5) binds target to a nearby large object on a failed Speed defense roll."
  },
  {
    name: "Deadshot",
    level: 5,
    ...
    combat: "Long‑range pistol attack deals 7 points of damage. Once a minute fires necrotic bullet that deals 3 points of damage each round (ignores Armor) until bullet extracted with a difficulty 4 healing task."
  },
  {
    name: "Gunslinger",
    level: 4,
    ...
    combat: "Long‑range pistol attack deals 6 points of damage (or 8 points with eased attack if they attack before their foe). Every hit increases damage by 1 point for the rest of the encounter (to a maximum of +10)."
  },
  {
    name: "Lawman",
    level: 5,
    ...
    combat: "Long‑range rifle attacks. The first time a lawman would normally succumb to their wounds, they instead gain a second wind (and 10 health). Banishing rounds deal full damage to ghosts and similarly protected creatures."
  },
  // NECROVORES (from quick reference list)
  {
    name: "Ghost Rider",
    level: 6,
    armor: 1,
    ...
    combat: "Rides a skeletal mount a long distance each round. Long‑range pistol attack deals 6 damage. Short‑range curse causes target who fails an Intellect defense roll to lose their next turn as they freeze in terror."
  },
  {
    name: "Wraith Lord",
    level: 5,
    ...
    combat: "Flies a short distance each round. Spectral weapon deals 6 points of Speed damage (ignores Armor) and induces target to fall one step on the damage track each day a Might defense roll fails (three successes purge the effect). If destroyed, usually reforms the following midnight."
  },
  {
    ...
    combat: "Long‑range necrotic blast deals 4 points of Speed damage (ignores Armor) to all in an immediate area, or 1 point even with a successful defense roll. Even‑numbered attack rolls that would reduce its health to 0 reduce health to 1 instead."
  }
];
...
function writeCreatureFiles() {
  ...
  console.log(`📊 Total: ${allCreatures.length} creature files`);
